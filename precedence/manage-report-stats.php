    ...
    <section class="common-space pt-3_7">
        <div class="container">
            ...
            <div class="row align-items-center light-bg pt-0">
                <div class="col-md-2">
                    <div class="search-btn shadow-lg search-filter" id="vn-click">
                ...
                <div class="col-md-10 text-end">
                    ...
                    <div class="lead-links d-flex align-items-center justify-content-end">
                        <a href="<?php echo SITEADMIN; ?>add-report-stats" class="s-btn ml-1 btn">
...
// </script>
   <script type="text/javascript">
        $(document).ready(function () {
         $.ajax({
				url: "<?php echo SITEADMIN; ?>manage-report-stats-pagination.php",
				type: "GET",
				data: {
					page : "1"
				},
