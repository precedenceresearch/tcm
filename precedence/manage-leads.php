        ...
        <div class="container">
            ...
            <div class="row align-items-center light-bg pt-0">
                ...
                <div class="col-md-10 text-end">
                    ...
                    <!--                     <a href="<?php echo SITEADMIN; ?>add-report" class="s-btn ml-1 btn">-->
                    ...
                    <div class="tab-content search-tab-content">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input class="form-control" type="text" placeholder="Email ID" aria-label="Search" name="email" id="email">
                                </div>
                                
                                <div class="col-md-2">
                                     <select class="form-select" aria-label="Default select example" id="formtype" name="formtype">
                                ...
                                <div class="col-md-3">
                                    <div class="text-end">
                                        ...
                                        <a href="javascript:void(0);" id="export-all-filter" class="export-list">
                                           <i class="fa fa-arrow-down"></i>
                                           Export List
                                        </a>
                                    </div>
    ...
    $(".form-control, .form-select").on("keypress", function (e) {
        ...
        function performSearch() {
		    ...
		    if(daterror == 0)
		    {
    		    $.ajax({
    				...
    				type: "GET",
    				data: {
    					page : "1",email:email,daterange:daterange,repid:repid,formtype:formtype
    				},
    				cache: false,
    			    beforeSend: function(){
		...
		$("#resetval").click(function(){
		    ...
		    $.ajax({
				...
				type: "GET",
				data: {
					page : "1",daterange:daterange,repid:repid,formtype:formtype
				},
				cache: false,
			    beforeSend: function(){
                   // Show image container
		...
		$("#export-all-filter").click(function(){
		    ...
		    var formtype=$("#formtype").val();
		    var daterange=$("#datetimerange-input1").val();
		    window.location="<?php echo SITEADMIN; ?>export-leads.php?daterange="+daterange+"&repid="+repid+"&formtype="+formtype;
