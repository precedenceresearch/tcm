...
$fields = "*";
$orderbyfreshleads="`news_id` DESC";
$limit ="$nextoffset,$limitcond";
$newsletter_details = $obj_newsletter->getNewsletterDetails($fields, $condition, $orderbyfreshleads, $limit,'', 0);
$all_category_cnt=$obj_newsletter->getNewsletterDetails($fields, $condition, $orderbyfreshleads, '', 0);
...
<tbody>
<?php 
    if(isset($newsletter_details) && !empty($newsletter_details))
    {
         if($page == 1)
         {
         $counter = 1;
...
<tr>
     ...
     <td><?php echo $newsletter_detail['email'];?></td>
     <td>
        <?php echo date("F d, Y",strtotime($newsletter_detail['created_at']));?>
     </td>
    
    <td class="text-end">
        <div style="display:flex;">
            <a class="m-1" title="Delete Paylink" href="delete-newsletter.php?newsletter_id=<?php echo base64_encode($newsletter_detail['news_id']);?>">
