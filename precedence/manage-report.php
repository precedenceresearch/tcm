    ...
    <section class="common-space pt-3_7">
        <div class="container">
            ...
            <div class="row align-items-center light-bg pt-0">
                <div class="col-md-2">
                    <div class="search-btn shadow-lg search-filter d-none" id="vn-click">
   ...
   <script type="text/javascript">
    ...
    $(".form-control, .form-select").on("keypress", function (e) {
        ...
        function performSearch() {
		    ...
		    if(daterror == 0)
		    {
    		    $.ajax({
    				...
    				type: "GET",
    				data: {
    					page : "1",daterange:daterange,repid:repid,reptitle:reptitle,repcategory:repcategory,formtype:formtype
    				},
    				cache: false,
    			    beforeSend: function(){
		...
		$("#resetval").click(function(){
		    ...
		    var formtype=$("#formtype").val();
		    var daterange=$("#datetimerange-input1").val();
		    window.location="<?php echo SITEADMIN; ?>export-reports.php?daterange="+daterange+"&repid="+repid;
