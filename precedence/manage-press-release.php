...
<?php include('sidebar-menu.php')?>
    ...
    <div class="container">
            <div class="row d-flex align-items-center pb-3 light-bg">
                    <div class="col-md-3">
                        <h5 class="page-header"><i class="fa fa-user"></i> Manage Press Release List</h5>
                        <!--<ol class="breadcrumb">
                    ...
                    <div class="col-md-9">
                        ...
                        <a href="<?php echo SITEADMIN; ?>add-press-release" class="btn s-btn float-end"><i class="fa fa-plus-circle"></i> Add Press Release</a>
