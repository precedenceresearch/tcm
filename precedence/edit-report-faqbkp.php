...
if (isset($_GET['report_id']) && $_GET['report_id'] != "") {
    ...
    $condition = "`rid` = '" . base64_decode($_GET['report_id']) . "'";
    $report_faq_details = $obj_report->getReportFAQDetails('', $condition, '', '', 0);
    $report_faq_detail = end($report_faq_details);
    $qno = base64_decode($_GET['editq']);
}
                          ...
                          <!--  <div class="panel-heading">
                            ...
                            <div class="shadow-lg add-card bg-white mt-3 mb-3">
                                ...
                                <form role="form" method="POST" action="<?php echo SITEADMIN; ?>edit-report-faq-action.php" class="lead-info-form support-box-form p-0" enctype="multipart/form-data" name="category-form" id="category-form">
                                        ...
                                        <input type="hidden" name="editq" id="editq" value="<?php echo $qno;?>">
                                        <div class="row">
                                            <div class="col-lg-12">
                                        <!-- / hidden fields -->
                                        <div class="form-group">
                                            <label>Question <span class="error">*</span></label>
                                            <input type="text" name="question" id="question" placeholder="Enter Question" class="form-control" value="<?php echo (isset($report_faq_detail['q'.$qno])) ? $report_faq_detail['q'.$qno] : ""; ?>">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Answer <span class="error">*</span></label>
                                            <textarea rows="3" name="answer" id="answer" placeholder="Enter Answer" class="form-control" style="height:74px;"><?php echo (isset($report_faq_detail['a'.$qno])) ? $report_faq_detail['a'.$qno] : "";?></textarea>
                                        </div>
